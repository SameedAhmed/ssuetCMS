...
def display():
	...
	# to display SGPA
	tk.Label(master, text=str(tot/5)).grid(row=9, column=4)
...
tk.Label(master, text="Semester").grid(row=0, column=3)
...
tk.Label(master, text="Subject Code").grid(row=2, column=1)
tk.Label(master, text="SWE-102T").grid(row=3, column=1)
tk.Label(master, text="SWE-105T").grid(row=4, column=1)
tk.Label(master, text="MS-108").grid(row=5, column=1)
tk.Label(master, text="HS-102").grid(row=6, column=1)
tk.Label(master, text="HS-101").grid(row=7, column=1)
...
tk.Label(master, text="2").grid(row=7, column=3)
...
button1 = tk.Button(master, text="submit",fg="white",bg="#A020F0", command=display)
